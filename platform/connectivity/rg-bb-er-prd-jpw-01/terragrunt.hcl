...
dependency "sidecar_prd_jpw_01" {
  ...
  mock_outputs = {
    snet_kv_id = "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/mock-rg/providers/Microsoft.Network/virtualNetworks/mock-vnet/subnets/mock-kv"
  }
  mock_outputs_allowed_terraform_commands = ["output", "validate", "plan"]
}
